...
<head>
    ...
    <title>Campanhas de Cobrança - URA Dvelopers</title>
...
<body>
    ...
    <div class="container">
        <main>
            <div class="card">
                <h2><i class="fas fa-file-invoice-dollar"></i> Campanhas de Cobrança</h2>
                ...
                <div style="overflow-x: auto;">
                    <table id="campanhasTable">
                        ...
                        <tbody id="campanhasBody">
                            <tr><td colspan="6" class="empty-state">Carregando campanhas...</td></tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        async function loadCampanhas() {
            try {
                ...
                const response = await fetchWithAuth(`${API_BASE_URL}/campanhas/cobranca?page=${currentPage}`);
        ...
        function renderTable(data) {
            ...
            if (!data.data || data.data.length === 0) {
                tbody.innerHTML = '<tr><td colspan="6" class="empty-state">Nenhuma campanha encontrada</td></tr>';
                return;
            }
            ...
            tbody.innerHTML = data.data.map(c => `
                <tr>
                    ...
                    <td>${c.contatos_sucesso}/${c.total_contatos}</td>
